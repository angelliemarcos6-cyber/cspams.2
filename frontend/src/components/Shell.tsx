...
export function Shell({ title, subtitle, children, actions }: ShellProps) {
  ...
  return (
    <div className="min-h-screen bg-page-bg">
      <header className="sticky top-0 z-50 border-b border-primary-200/25 bg-gradient-to-r from-primary-900 via-primary-800 to-primary-700 shadow-xl shadow-primary-900/30">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 text-white">
            <div className="hidden border border-white/20 bg-white/10 px-3 py-1.5 text-xs sm:block">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 border border-white/35 bg-white/10 px-3 py-2 text-xs font-semibold transition hover:bg-white/20"
            >
        ...
        <div className="border-t border-white/12 bg-primary-800/75 backdrop-blur-sm">
          <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 py-3 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div>
              <p className="inline-flex items-center gap-2 border border-white/25 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-primary-100">
            ...
            <div className="flex flex-wrap items-center gap-3 lg:justify-end">
              <span className="inline-flex items-center gap-2 border border-white/20 bg-white/10 px-3 py-2 text-xs font-medium text-white">
      ...
      <main className="mx-auto w-full max-w-7xl px-4 pb-7 pt-0 sm:px-6 lg:px-8">
        {children}
      </main>
    </div>
  );
