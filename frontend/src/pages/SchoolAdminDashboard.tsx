  ...
  return (
    ...
    >
      ...
      <section id="school-info" className={`mb-4 grid gap-2 md:grid-cols-2 xl:grid-cols-4 ${focusCls("school-info")}`}>
        <article className="rounded-sm border border-slate-200 bg-white px-4 py-3">
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Assigned School</p>
          <p className="mt-0.5 text-sm font-bold text-slate-900">{schoolName}</p>
        </article>
        <article className="rounded-sm border border-slate-200 bg-white px-4 py-3">
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">School Code</p>
          <p className="mt-0.5 text-sm font-bold text-slate-900">{schoolCode}</p>
        </article>
        <article className="rounded-sm border border-slate-200 bg-white px-4 py-3">
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Region</p>
          <p className="mt-0.5 text-sm font-bold text-slate-900">{schoolRegion}</p>
        </article>
        <article className="rounded-sm border border-slate-200 bg-white px-4 py-3">
      ...
      <section id="file-reports" className={`mb-5 ${focusCls("file-reports")}`}>
        ...
        <div className="flex flex-col gap-4 md:flex-row">
          {([
            ...
            return (
              <article key={report.type} className="flex-1 rounded-sm border border-slate-200 bg-white px-4 py-3">
                <div className="flex items-center justify-between gap-2">
                  <h3 className="text-xs font-bold uppercase tracking-wide text-slate-700">{report.title}</h3>
                ...
                <dl className="mt-3 space-y-1.5">
                  <div className="flex items-start gap-2 text-xs">
                    <dt className="w-10 shrink-0 font-semibold text-slate-500">File</dt>
                    <dd className="truncate font-medium text-slate-700">{report.file?.originalFilename ?? "- (none)"}</dd>
                  </div>
                  <div className="flex items-start gap-2 text-xs">
                    <dt className="w-10 shrink-0 font-semibold text-slate-500">Date</dt>
                ...
                <div className="mt-3">
                  {hasFile ? (
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-1.5 rounded-sm border border-primary-300 bg-primary-50 px-3 py-2 text-xs font-semibold text-primary-700 transition hover:bg-primary-100"
                    >
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-1.5 rounded-sm border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-600 transition hover:bg-slate-50"
                    >
